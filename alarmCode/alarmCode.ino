...
pinMode(redPin2, OUTPUT); //Set redPin to be an output
pinMode(greenPin2, OUTPUT); //Set greenPin to be an output
pinMode(bluePin, OUTPUT); //set bluePin to be an output
pinMode(bluePin2, OUTPUT); //set bluePin to be an output
